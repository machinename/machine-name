            ...
            <div className={styles.modal}>
                <Paper className={styles.wrapper}>
                    ...
                    <div className={styles.footer}>
                        ...
                        <p><Link href={'public/Machine Name - Privacy Policy.pdf'} className={styles.textTerms}
                            target="_blank" rel="noopener noreferrer">Terms of Service</Link> & <Link href={'public/Machine Name - Privacy Policy.pdf'}
